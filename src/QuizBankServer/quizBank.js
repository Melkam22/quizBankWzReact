const myQuestionBank = [
    {
      question:
        "What was the capital city of West Germany during the cold war?   ",
      answers: ["Bonn", "Berlin", "Frankfurt", "Munic"],
      correct: "Bonn",
      questionId: "1"
    },
    {
    ...
    {
      question:
        "Who is the author of La Divine Comedy?",
      answers: ["Plato", "Dante", "Aristotle", "Marx"],
      correct: "Dante",
      questionId: "3"
    },
    {
      question: "What's the name of Microsoft's founder?",
      answers: [
        "Bill Gates",
        "Lauren Buffet",
        "Jason & Sarah",
    ...
    {
      question:
        'What does the letter "T" represent in the word "NATO" ?',
      answers: ["Tomorrow", "Time", "Treaty", "Testimony"],
      correct: "Treaty",
      questionId: "7"
    },
    {
  ...
  export default (n = 10) =>
    Promise.resolve(myQuestionBank.sort(() => 0.5 - Math.random()).slice(0, n));